...
class Sordo(models.Model):
    ...
    tipo_senias = models.CharField(max_length=20, blank=True, verbose_name="Tipo de Señas")
    anio_nacimiento = models.IntegerField(blank=True, null=True, verbose_name="Año de Nacimiento")
    ...
    detalles_direccion = models.CharField(max_length=400, blank=True, verbose_name="Detalles de la Dirección")
    ...
    detalles_sordo = models.CharField(max_length=400, blank=True, verbose_name="Detalles del Sordo")
    detalles_familia = models.CharField(max_length=200, blank=True, verbose_name="Detalles de la Familia")
