...
def generar_kml_sordos():
    ...
    sordos =  requests.post('http://localhost:8000/api/sordos/para_kml_y_gpx/', json = data, timeout=60).json()
    ...
    data = {'congregacion_id': 1}
    territorios =  requests.post('http://localhost:8000/api/territorios/congregacion/', json = data, timeout=60).json()
